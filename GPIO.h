...
/** Sets interrupt status flag  to be detected*/
#define ISF				   0x01000000

/** Sets all port as Output */
#define PORT_OUT		   0xFFFFFFFF
/** Sets all port as Input */
...
/*!
 	 ...
 	 \return void
 */
void GPIO_tooglePIN(gpio_port_name_t port_name, uint8_t pin);
